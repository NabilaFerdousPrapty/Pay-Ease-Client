        ...
        <div>
            <div className="flex justify-center h-screen">
                <div className="hidden bg-cover lg:block lg:w-2/3" style={{
                    backgroundImage: 'url(https://i.ibb.co/t4NR5S6/wristwatch-cellphone-credit-card-blue-surface-online-shopping.jpg)',
                    backgroundSize: 'cover',
                    backgroundPosition: 'center center'
                }}>
                    <div className="flex items-center h-full px-20 bg-gray-900 bg-opacity-40 justify-end">
                        <div className="lg:mt-20">
                            <h2 className="text-2xl font-bold text-white sm:text-3xl">Pay Ease</h2>
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-8">
                            <form onSubmit={handleSubmit(onSubmit)}>
                                ...
                                <div className="mt-6">
                                    <div className="flex justify-between mb-2">
                                        <label htmlFor="pin" className="text-sm text-gray-600 dark:text-gray-200">PIN</label>
                                        <a href="#" className="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">Forgot PIN?</a>
                                    </div>
                                    <input type="password" 
                                           {...register("pin", { required: true })}
                                           name="pin" id="pin" placeholder="Your PIN"
                                           className="block w-full px-4 py-2 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 focus:ring focus:ring-opacity-40" />
                            ...
                            <p className="mt-6 text-sm text-center text-gray-400">Don’t have an account yet? 
                                <Link to={'/signup'} className="text-blue-500 focus:outline-none hover:underline">Sign up</Link>.
                            </p>
                        </div>
                    </div>
                </div>
